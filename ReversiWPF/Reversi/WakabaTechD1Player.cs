...
namespace ReversiEngine.Reversi {
    ///<summary>吉村プレイヤー (ゲーム木の深さ1)</summary>
    public class WakabaTechD1Player : Player {
        Stone player_color;
        Evaluator evaluator;
        
        /// <summary>コンストラクタ</summary>
        /// <param name="player_color">石の色</param>
        public WakabaTechD1Player(Stone player_color) {
        ...
        public Decision Play(Board current_board) {
            ...
            return AlphaBetaMethod<State, Decision>.Search(root_state, 1, Decision.Pass);
        }
